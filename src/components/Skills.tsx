    ...
    <section id="skills" className="fade-in">
      <div className="container">
        <div className="section-header">
          <h2 className="section-title">Sunduğumuz Teknolojiler</h2>
          ...
          <div className="skills-wrapper">
            ...
            <div className="skills-list">
              <div className="skill-item">
                ...
                <div className="skill-progress"><div className="skill-progress-bar" style={{ width: "100%" }}></div></div>
              </div>
              <div className="skill-item">
                <h4>UI/UX Tasarım</h4>
                <p>Müşterilerinizin kolayca kullanabileceği, şık ve erişilebilir arayüzler ile dijital varlığınızı güçlendiriyoruz.</p>
                <div className="skill-progress"><div className="skill-progress-bar" style={{ width: "1000%" }}></div></div>
              </div>
              <div className="skill-item">
